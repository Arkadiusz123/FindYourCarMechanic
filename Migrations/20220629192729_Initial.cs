    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConfirmedRepairs", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ConfirmedRepairs_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ConfirmedRepairs_Mechanics_MechanicId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConfirmedRepairs_CarId",
                table: "ConfirmedRepairs",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_ConfirmedRepairs_MechanicId",
                table: "ConfirmedRepairs",
                column: "MechanicId");
